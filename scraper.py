...
def geocode_(address):
    geocoding_url = "https://maps.googleapis.com/maps/api/geocode/json?address=%s&key=AIzaSyDPORyFiuMXkIgO0hniehw-XCZf5Qp9XSQ"%address
...
def adler():
    ...
    r = requests.post(url,
        data=json.dumps({'question':{'questionText':qt,'evidenceRequest':{'items':1}}}),
